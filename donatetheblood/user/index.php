							...
							<?php
								...
								if ($safeDate == '0') 
								{
									echo '<form target="" method="post">
										<button style="margin-top: 20px;" name="date" id="save_life_date" class="btn btn-lg btn-danger center-aligned ">Save The Life</button>
										</form>';
								}
								else
								{                     //year-month-days
									...
									echo '<div class="donors_data">
    		   		      				...
    		   		      				<span> You Already Safe the life. You will donate the blood after three months. We are very thanking full to you.
										</span>
    		   		      			</div> ';
