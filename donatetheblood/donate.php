...
if (isset($_POST['submit'])) { // Check if form is submitted
    if (isset($_POST['term'])=== true) { // Check if terms are agreed
        if (isset($_POST['name']) && !empty($_POST['name'])) {
            //name input check
            if (preg_match('/^[A-Za-z ]+$/', $_POST['name'])) { // Allow spaces in name
                $name = $_POST['name'];
            } else {
        ...
        if (isset($_POST['city']) && !empty($_POST['city'])) {
            ...
            if (preg_match('/^[A-Za-z ]+$/', $_POST['city'])) { // Allow spaces in name
                $city = $_POST['city'];
            } else {
        ...
        if (isset($_POST['contact_no']) && !empty($_POST['contact_no'])) {
            ...
            if (preg_match('/\d{10}/', $_POST['contact_no'])) { // Allow spaces in
        ...
        if(isset($_POST['password']) && !empty($_POST['password']) && 
            ...
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        		...
        		// Database connection (ensure this is at the top of your file)
...
//email input check
     if (isset($_POST['email']) && !empty($_POST['email'])) {
            ...
            if (preg_match( $pattern,$_POST['email'])) { // Allow spaces in name
        ...
        if(isset($name)&& isset($blood_group) && isset($gender) && isset($day)&& isset($month) && isset($year) && isset($email) && isset($contact_no) && isset($city) && isset($password))
        {
            ...
            //md5 is used to encryption
            $password = md5($password);

            $sql = "INSERT INTO donor (
                name,gender,email,city,dob,contact_no,save_life_date,password,blood_group) VALUES('$name','$gender', '$email','$city','$DonorDOB','$contact_no','0','$password','$blood_group')";
